  ...
  return (
    <div className={`sm:px-5 px-0 bg-white sm:h-20 z-10 shadow-md mb-10`}>
      <div className='p-3 sm:mx-auto flex flex-col  w-full sm:justify-between sm:flex-row sm:border-none border-b-[1px]'>
        ...
        <div className={`relative sm:w-3/4 z-10 lg:w-1/2  flex flex-col w-full sm:my-auto sm:flex-row justify-around `}>
          <ul className={`absolute sm:flex  sm:rounded-none rounded-b-xl sm:shadow-none shadow-xl  sm:static sm:justify-around  w-full top-5 ${isOpen ? 'left-0 right-0' : '-left-[640px]'} divide-y-2 sm:divide-none transition-all`}>
